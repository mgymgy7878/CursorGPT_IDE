@echo off
rem Fast Startup sigortası: Kullanıcı logon'da daemon'u başlatır
...
set "DAEMON=%ROOT%\tools\WEBNEXT_DAEMON.cmd"

rem Daemon zaten çalışıyorsa tekrar başlatma (port kontrolü)
