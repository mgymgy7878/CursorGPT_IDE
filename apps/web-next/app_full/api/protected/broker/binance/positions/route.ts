// moved from pages/api/broker/binance/positions.ts to app/api/protected/broker/binance/positions/route.ts
...
export async function GET(_req: NextRequest) {
  try {
    ...
    const data = await withRetry(() => binance.getPositions())
