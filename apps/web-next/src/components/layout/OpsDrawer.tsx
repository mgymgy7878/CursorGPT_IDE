...
export function OpsDrawer() {
  ...
  return (
    <>
      <button
        className="rounded-lg px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium transition-colors whitespace-nowrap min-w-[140px] shrink-0"
