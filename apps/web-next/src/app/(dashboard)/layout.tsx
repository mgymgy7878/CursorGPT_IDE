...
import { Activity, Cpu, FileText, GitBranch, Shield, TrendingUp, Settings, Bot, AlertCircle } from 'lucide-react';
...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  const navItems = [
    ...
    { href: '/strategy-bot', label: 'Strategy Bot', icon: Bot },
    { href: '/charts/equity', label: 'Equity Chart', icon: TrendingUp },
    { href: '/alerts', label: 'Uyarılar', icon: AlertCircle },
    { href: '/settings/ai', label: 'AI Ayarları', icon: Settings },
