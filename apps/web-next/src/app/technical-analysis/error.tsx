...
export default function TechnicalAnalysisError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-screen grid place-items-center bg-black p-6">
      <div className="max-w-md border border-neutral-800 rounded-lg p-6">
        <h2 className="text-xl font-bold mb-2 text-white">Teknik Analiz Hatası</h2>
        <p className="text-neutral-400 mb-4">
          Teknik analiz sayfası yüklenirken bir hata oluştu.
        </p>
