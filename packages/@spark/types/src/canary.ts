...
export type LiveTradeApplyRequest = {
  ...
  side: "BUY" | "SELL";
  allowLive: true;
  idempotencyKey?: string;   // Aynı isteği tekrarlamaya karşı koruma
  traceparent?: string;      // Dağıtık izleme
};
...
export function normalizeThresholds(partial?: Partial<CanaryThresholds>): CanaryThresholds {
  return {
    ...CANARY_THRESHOLDS,
    ...partial
  };
