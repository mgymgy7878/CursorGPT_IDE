// Export@Scale + Observability Plugin (v1.7)
// Real CSV/PDF export with streaming, backpressure, rate limiting
import { FastifyPluginAsync } from 'fastify';
import { writeCsv, ExportConfig } from "../../../packages/exporter-core/src/csvWriter.js";
import { writePdf, PdfExportConfig } from "../../../packages/exporter-core/src/pdfWriter.js";
import { 
  exportRequestsTotal, 
  exportConcurrentRunning, 
  exportQueueDepth,
  exportFailTotal,
  exportSuccessRate,
  exportThroughputOpsPerSec,
  register 
} from "../../../packages/exporter-core/src/metrics.js";
...
export const exportPlugin: FastifyPluginAsync = async (fastify) => {
